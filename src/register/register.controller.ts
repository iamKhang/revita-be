...
export class RegisterController {
  ...
  @ApiOperation({ 
    ...
    description: 'Người dùng nhập số điện thoại hoặc email để bắt đầu quá trình đăng ký. Hệ thống sẽ gửi mã OTP.'
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Người dùng nhập mã OTP nhận được để xác thực số điện thoại hoặc email.'
  })
    ...
    schema: {
      ...
      properties: {
        ...
        message: {
          type: 'string',
          description: 'Thông báo kết quả',
          example: 'Xác thực OTP thành công. Vui lòng hoàn tất thông tin đăng ký.'
        }
      }
    }
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Người dùng nhập các thông tin cá nhân để hoàn tất quá trình đăng ký.'
  })
